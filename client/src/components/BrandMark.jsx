/**
 * The Chatter speech-bubble mark, as a React component so it scales crisply
 * anywhere in the UI instead of loading favicon.svg as an <img>. Decorative
 * by default (aria-hidden); pass `title` when the mark is the only content
 * conveying meaning (e.g. a standalone logo link).
 */
